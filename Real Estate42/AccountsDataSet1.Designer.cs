...
namespace Real_Estate42 {
    ...
    public partial class AccountsDataSet1 : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsRow AddAccountsRow(string Username, int Password, string Email, int Phone) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public int Password {
                get {
                    try {
                        return ((int)(this[this.tableAccounts.PasswordColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public int Phone {
                get {
                    try {
                        return ((int)(this[this.tableAccounts.PhoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Real_Estate42.AccountsDataSet1TableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Accounts` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Accounts` (`Username`, `Password`, `Email`, `Phone`) VALUES (?, ?, ?" +
                ", ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Accounts` SET `Username` = ?, `Password` = ?, `Email` = ?, `Phone` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Real_Estate42.Properties.Settings.Default.AccountsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, [Password], Email, Phone FROM Accounts";
        ...
        public virtual int Fill(AccountsDataSet1.AccountsDataTable dataTable) {
        ...
        public virtual AccountsDataSet1.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AccountsDataSet1.AccountsDataTable dataTable = new AccountsDataSet1.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AccountsDataSet1.AccountsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Username, global::System.Nullable<int> Original_Password, string Original_Email, global::System.Nullable<int> Original_Phone) {
        ...
        public virtual int Insert(string Username, global::System.Nullable<int> Password, string Email, global::System.Nullable<int> Phone) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, global::System.Nullable<int> Password, string Email, global::System.Nullable<int> Phone, int Original_ID, string Original_Username, global::System.Nullable<int> Original_Password, string Original_Email, global::System.Nullable<int> Original_Phone) {
            if ((Username == null)) {
